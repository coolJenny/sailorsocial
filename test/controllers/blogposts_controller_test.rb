...
class BlogpostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blogpost" do
    assert_difference('Blogpost.count') do
      post blogposts_url, params: { blogpost: { content: @blogpost.content, title: @blogpost.title, user_id: @blogpost.user_id } }
    end
  ...
  test "should update blogpost" do
    patch blogpost_url(@blogpost), params: { blogpost: { content: @blogpost.content, title: @blogpost.title, user_id: @blogpost.user_id } }
